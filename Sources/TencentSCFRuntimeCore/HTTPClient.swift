        ...
        let bootstrap = ClientBootstrap(group: self.eventLoop)
            .channelInitializer { channel in
                do {
                    ...
                    // Quota Limits... An invocation payload is maximal 6MB in size:
                    //   https://intl.cloud.tencent.com/document/product/583/11637
...
private final class LambdaChannelHandler: ChannelDuplexHandler {
    ...
    func channelRead(context: ChannelHandlerContext, data: NIOAny) {
        ...
        if closeConnection {
            ...
            //
            // The SCF runtime will ask for the next work item directly after a succeeded post
            ...
            // SCF control plane demanding to close connection. (It's more or less only
            // implemented to support http1.1 correctly.) This behavior is ensured with the test
            // `SCFTest.testNoKeepAliveServer`.
